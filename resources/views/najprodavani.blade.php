...
<head>
    ...
    <title>Shop Homepage - Start Bootstrap Template</title> <!-- change this title -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="/najprodavani">Најпродавани</a></li>
                <li><a  href="#">
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 content">
    		...
    		<span class="thumbnail">
      			...
      			<div class="row">
      				...
      				<div class="col-md-6 col-sm-6">
      					<button type="button" class="btn-sm btn-primary site-btn3">Купи сега!</button>
      				</div>
