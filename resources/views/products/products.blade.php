                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h3 class="modal-title"><a href="/{{$product->slug}}">{{$product->ime}}</a></h3>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6 product_img">
                                                {{-- <img src="http://img.bbystatic.com/BestBuy_US/images/products/5613/5613060_sd.jpg" class="img-responsive">--}}
                                                <img src='http://127.0.0.1:8000/produkti-sliki/{{$product->slika}}' alt="Ne rabote" class="img-responsive">
                                            </div>
                                            <div class="col-md-6 product_content">



                                                <h3 class="cost">{{$product->cena}} Денари <small class="pre-cost">{{--<span class="glyphicon glyphicon-usd"></span> 60.00</small>--}}</h3>
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="btn-ground">
                                                            <a href="/login" class="btn btn-primary"><span class="glyphicon glyphicon-shopping-cart"></span> Купи производ</a>
